...
if __name__ == "__main__":
    # ble_packet = packet_gen('8e89bed6', 'ADV_IND', '90d7ebb19299', [['FLAGS', '02'], ['128BIT_SERVICE_UUID_COMPLETE', "21A607C77B7D49EFB7F3BE924588CCA1"], ['COMPLETE_LOCAL_NAME', 'SCUM3']])
    # ble_packet = packet_gen('8e89bed6', 'ADV_NONCONN_IND', '90d7ebb19299', [['FLAGS', '06'], ['128BIT_SERVICE_UUID_COMPLETE', "21A607C77B7D49EFB7F3BE924588CCA1"], ['COMPLETE_LOCAL_NAME', 'SCUM3']])
    ...
    # ble_packet = packet_gen('8e89bed6', 'SCAN_RSP', '90d7ebb19299', [])
    # ble_packet = packet_gen('8e89bed6', 'ADV_NONCONN_IND', '90d7ebb19299', [['FLAGS', '06'], ['COMPLETE_LOCAL_NAME', ''.join(chr(c) for c in range(ord('A'), ord('Z') + 1))]])
    # ble_packet = packet_gen('8e89bed6', 'ADV_NONCONN_IND', '90d7ebb19299', [['FLAGS', '06'], ['COMPLETE_LOCAL_NAME', 'SCUM3'], ['MANUFACTURER_SPECIFIC_DATA', 'ff02beef']])
